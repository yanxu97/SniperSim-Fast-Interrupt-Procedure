...
SchedulerPinned::SchedulerPinned(ThreadManager* thread_manager)
    ...
    , m_next_core(0)
{
    std::cerr << "[IAN's TESTING] scheduler_pinned.cc: CREEPY MOVEMENT: SchedulerPinned" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] scheduler_pinned.cc: CREEPY MOVEMENT: getNextCore" << std::endl;
    while (true) {
...
{
    std::cerr << "[IAN's TESTING] scheduler_pinned.cc: CREEPY MOVEMENT: getFreeCore" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] scheduler_pinned.cc: CREEPY MOVEMENT: threadSetInitialAffinity" << std::endl;
