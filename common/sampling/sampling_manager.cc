...
{
    std::cerr << "[IAN's TESTING] sampling_manager.cc: CREEPY MOVEMENT: SamplingManager" << std::endl;
    std::cerr << "[IAN's TESTING] current sampling enable status: " << m_sampling_enabled << std::endl;
...
{
    std::cerr << "[IAN's TESTING] sampling_manager.cc: CREEPY MOVEMENT: disableFastForward" << std::endl;
