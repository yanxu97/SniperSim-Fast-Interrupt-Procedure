...
{
    std::cerr << "[IAN's TESTING] py_thread.cc: CREEPY MOVEMENT: getNthreads" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] py_thread.cc: CREEPY MOVEMENT: getThreadAppid" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] py_thread.cc: CREEPY MOVEMENT: getThreadName" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] py_thread.cc: CREEPY MOVEMENT: getThreadAffinity" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] py_thread.cc: CREEPY MOVEMENT: setThreadAffinity" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] py_thread.cc: CREEPY MOVEMENT: setup" << std::endl;
