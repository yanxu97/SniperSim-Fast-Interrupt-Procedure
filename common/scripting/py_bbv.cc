...
{
    std::cerr << "[IAN's TESTING] py_bbv.cc: CREEPY MOVEMENT: enableBbv" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] py_bbv.cc: CREEPY MOVEMENT: disableBbv" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] py_bbv.cc: CREEPY MOVEMENT: getBbv" << std::endl;
