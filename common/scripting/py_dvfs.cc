...
{
    std::cerr << "[IAN's TESTING] py_dvfs.cc: CREEPY MOVEMENT: getDomain" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] py_dvfs.cc: CREEPY MOVEMENT: getFrequency" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] py_dvfs.cc: CREEPY MOVEMENT: setFrequency" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] py_dvfs.cc: CREEPY MOVEMENT: setup" << std::endl;
