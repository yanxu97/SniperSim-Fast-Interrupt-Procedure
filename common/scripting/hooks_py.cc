...
void HooksPy::init()
{
    std::cerr << "[IAN's TESTING] hooks_py.cc: CREEPY MOVEMENT: init" << std::endl;
...
void HooksPy::setup()
{
    std::cerr << "[IAN's TESTING] hooks_py.cc: CREEPY MOVEMENT: setup" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] hooks_py.cc: CREEPY MOVEMENT: callPythonFunction" << std::endl;
