...
{
    // std::cerr << "[IAN's TESTING] magic_server.cc: CREEPY MOVEMENT: Magic" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] magic_server.cc: CREEPY MOVEMENT: Magic_unlocked " << cmd << std::endl;
    PerformanceModel* perf = Sim()->getCoreManager()->getCoreFromID(0)->getPerformanceModel();
    SubsecondTime roi_begin_time = SubsecondTime::Zero();
    SubsecondTime roi_end_time = SubsecondTime::Zero();
    if (cmd == SIM_CMD_ROI_START) {
        roi_begin_time = perf->getElapsedTime();
        std::cerr << "ROI BEIGN TIME: " << roi_begin_time << std::endl;
    } else if (cmd == SIM_CMD_ROI_END) {
        roi_end_time = perf->getElapsedTime();
        std::cerr << "ROI END TIME: " << roi_end_time << std::endl;
    }
    switch (cmd) {
...
{
    // std::cerr << "[IAN's TESTING] magic_server.cc: CREEPY MOVEMENT: getGlobalInstructionCount" << std::endl;
...
{
    // std::cerr << "[IAN's TESTING] magic_server.cc: CREEPY MOVEMENT: enablePerformance" << std::endl;
...
{
    // std::cerr << "[IAN's TESTING] magic_server.cc: CREEPY MOVEMENT: disablePerformance" << std::endl;
...
{
    // std::cerr << "[IAN's TESTING] magic_server.cc: CREEPY MOVEMENT: setPerformance" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] magic_server.cc: CREEPY MOVEMENT: setFrequency" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] magic_server.cc: CREEPY MOVEMENT: getFrequency" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] magic_server.cc: CREEPY MOVEMENT: setInstrumentationMode" << std::endl;
