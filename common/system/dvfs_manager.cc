...
{
    std::cerr << "[IAN's TESTING] dvfs_manager.cc: CREEPY MOVEMENT: DvfsManager" << std::endl;
    ...
    std::cerr << "The core frequency is : " << core_frequency << std::endl;
...
{
    std::cerr << "[IAN's TESTING] dvfs_manager.cc: CREEPY MOVEMENT: setCoreDomain" << std::endl;
    if (core_id < m_num_app_cores) {
