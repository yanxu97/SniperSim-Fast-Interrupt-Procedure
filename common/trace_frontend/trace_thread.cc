...
TraceThread::TraceThread(Thread* thread, SubsecondTime time_start, String tracefile, String responsefile, app_id_t app_id, bool cleanup)
    ...
    , m_stopped(false)
{
    // std::cerr << "[IAN's TESTING] trace_thread.cc: CREEPY MOVEMENT: TraceThread" << std::endl;
...
UInt64 TraceThread::va2pa(UInt64 va, bool* noMapping)
{
    ...
    // std::cerr << "[IAN's TESTING] trace_thread.cc: CREEPY MOVEMENT: va2pa" << std::endl;
...
UInt64 TraceThread::remapAddress(UInt64 va_page)
{
    ...
    std::cerr << "[IAN's TESTING] trace_thread.cc: CREEPY MOVEMENT: remapAddress" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] trace_thread.cc: CREEPY MOVEMENT: handleOutputFunc" << std::endl;
...
{
    // std::cerr << "[IAN's TESTING] trace_thread.cc: CREEPY MOVEMENT: handleSyscallFunc" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] trace_thread.cc: CREEPY MOVEMENT: handleNewThreadFunc" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] trace_thread.cc: CREEPY MOVEMENT: handleForkFunc" << std::endl;
...
{
    // std::cerr << "[IAN's TESTING] trace_thread.cc: CREEPY MOVEMENT: handleJoinFunc" << std::endl;
...
{
    // std::cerr << "[IAN's TESTING] trace_thread.cc: CREEPY MOVEMENT: handleMagicFunc" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] trace_thread.cc: CREEPY MOVEMENT: handleRoutineChangeFunc" << std::endl;
...
{
    // too many times occuring
    // std::cerr << "[IAN's TESTING] trace_thread.cc: CREEPY MOVEMENT: handleEmuFunc" << std::endl;
