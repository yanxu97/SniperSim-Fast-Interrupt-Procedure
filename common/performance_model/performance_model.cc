...
{
    //  default: (ID, 0); (type, interval);
    std::cerr << "[IAN's TESTING] performance_model.cc: CREEPY MOVEMENT: create" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] performance_model.cc: CREEPY MOVEMENT: detail mode on: " << m_enabled << std::endl;
...
{
    std::cerr << "[IAN's TESTING] performance_model.cc: CREEPY MOVEMENT: detail mode off: " << m_enabled << std::endl;
...
void PerformanceModel::handleIdleInstruction(PseudoInstruction* instruction)
{
    ...
    std::cerr << "[IAN's TESTING] performance_model.cc: CREEPY MOVEMENT: handleIdleInstruction" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] performance_model.cc: CREEPY MOVEMENT: incrementIdleElapsedTime" << std::endl;
...
{
    std::cerr << "[IAN's TESTING] performance_model.cc: CREEPY MOVEMENT: setElapsedTime" << std::endl;
