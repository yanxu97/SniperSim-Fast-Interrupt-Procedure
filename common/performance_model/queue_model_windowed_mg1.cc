...
{
    //  Never being called... Won't put into consideration right now.
    //  std::cerr << "[IAN's TESTING] queue_model_windowed_mg1.cc: CREEPY MOVEMENT: computeQueueDelay" << std::endl;
    //  counter_sim++;
...
void QueueModelWindowedMG1::addItem(SubsecondTime pkt_time, SubsecondTime service_time)
{
...
void QueueModelWindowedMG1::removeItems(SubsecondTime earliest_time)
{
